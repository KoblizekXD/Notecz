...
export const notes = new Elysia()
  ...
  .post('/:id/comments', async ({ body, params, authManager }) => {
  ...
  .get('/:id', async ({ params }) => {
    ...
    detail: {
      ...
      responses: {
        200: {
          description: 'Request was sucessful, response body contains the note and its comments',
          content: {
            'application/json': {
              schema: {
                type: 'object',
                  ...
                  comments: {
                    ...
                    items: {
                      ...
                      properties: {
                        ...
                        userId: {
                          type: 'string',
                          description: 'Unique identifier of the author of the comment'
                        }
                      }
                    }
                  }
